        ...
        <div id="main__content">
            ...
            <nav aria-label="breadcrumb" class="p-2 p-sm-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item fw-bold active">Editar colaborador</li>
                </ol>
            </nav>
            <form class="row" id="formDatos" novalidate>
                            ...
                            <div class="accordion-body row">
                                <div class="col-12 col-sm-12 col-md-2 col-lg-3 p-0 mb-3 mt-3" id="photo__perfil">
                                    <input type="file" class="hide" name="foto" id="file-profile"
                                        accept=".jpg, .jpeg, .png">
                                    <img id="photoColaborador" name="photoColaborador" src="../src/img/user.png"
                                        onerror="this.onerror=null; this.src='../src/img/user.png';" alt="Colaborador">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <!-- <input type="text" readonly class="form-control" name="genero"
                                                    id="iptGenero" placeholder="Femenino / Masculino"
                                                    aria-label="Género"> -->
                                                <select class="form-select" name="genero" id="iptGenero" aria-label="Género">
                            ...
                            <div class="accordion-body row">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                                    ...
                                    <select class="form-select text-uppercase" name="departamento" id="cbDepto"
                                        aria-label="Departamento" required></select>
                                </div>
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                                    ...
                                    <select class="form-select text-uppercase" name="puesto" id="cbPuesto"
                                        aria-label="Puesto" required></select>
                                </div>
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                                    <label for="iptTelEmp" class="form-label fw-bold">Teléfono de empresa</label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="icon-phone"></i></span>
                                        <input type="text" class="form-control" placeholder="962 123 45 67"
                                                maxlength="10" autocomplete="off"
                                            aria-label="Telefono de empresa" name="Telefono_Empresa" id="iptTelEmp">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    <label for="iptOpiniones" class="form-label fw-bold">Opiniones sobre el
                                        colaborador</label>
                                    <textarea class="form-control" name="opiniones" id="iptOpiniones"
                ...
                <div class="col-12 mt-4 mb-4">
                    <button type="submit"
                        class="btn btn-primary col-12 col-sm-6 offset-sm-3 col-md-4 offset-md-4">Actualizar
                        información</button>
                </div>
            </form>
