<header class="bg-dia" id="navbarFondo">
    <section>
        <span type="button" id="btnSidebar"><i class="icon-menu"></i></span>
        <img onclick="location.reload()" class="d-none d-sm-block pointer"
            src="https://erp-varoch.com/DEV/src/img/logos/logo_row_wh.png" alt="Grupo Varoch">
        <img onclick="location.reload()" class="d-block d-sm-none"
            src="https://erp-varoch.com/DEV/src/img/logos/logo_icon_wh.png" alt="Grupo Varoch">
    </section>
    <style>
        .f-10 {
    ...
    <nav>
        <ul class="theme" id="navbar">
            ...
            <li class="">
                <a href="https://www.erp-varoch.com/ERP24/calendarizacion/actividades.php" class="d-none" style="text-decoration:none;color:#FFF;"><i
                        class="icon-calendar"></i></a>
            </li>
            <li onclick="toast.niggaMode()">
...
<div class="offcanvas  offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop"
    ...
    <div class="offcanvas-header">
        <h6 class="offcanvas-title" id="staticBackdropLabel"> <i class="icon-bell"></i> Notificaciones</h6>
...
<!-- CSS -->
<!--<link rel="stylesheet" href="https://erp-varoch.com/DEV/src/plugin/crispy-notify/styles/toast.css" />-->
<script type= "module">

</script>
<script src="https://erp-varoch.com/DEV/layout/src/js/sidebar.js?t=<?php echo time(); ?>"></script>
