!(function (e, t) {
    ...
    var Ze = "Domingo_Lunes_Martes_Miércoles_Jueves_Viernes_Sábado".split(
        "_"
    );
    ...
    var Mt =
        /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Ene|Feb|Mar|Abr|May|Jun|Jul|Ago|Sep|Oct|Nov|Dic)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;
